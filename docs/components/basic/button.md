...
| 参数                       | 说 明                                                                                                                                                     | 类型    | 可选值                                                | 默认值       |
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|---------|-------------------------------------------------------|--------------|
| type                       | 类型                                                                                                                                                      | string  | primary / info / warning / danger / success / default | default      |
| form-type                  | 表单类型                                                                                                                                                  | string  | button / submit / reset                               | button       |
...
| show-message-card`v1.1.5`  | 是否显示会话内消息卡片，设置此参数为 true，用户进入客服会话会在右下角显示“可能要发送的小程序”提示，用户点击后可快速发送小程序消息（open-type="contact" 时有效） | boolean | -                                                     | `false`      |

...
```html
<template>
  <nut-price :price="0" size="small"></nut-price>
  <nut-price :price="0" size="normal"></nut-price>
  <nut-price :price="0" size="large"></nut-price>
</template>
```
...
```html
<template>
  <nut-price :price="8888" :decimal-digits="0"></nut-price>
</template>
```
...
```html
<template>
  <nut-price :price="8888" strike-through></nut-price>
</template>
```
...
```html
<template>
  <nut-price :price="10010.01" symbol="¥"></nut-price>
</template>
```
...
```html
<template>
  <nut-price :price="8888.01" position="after" symbol="元"></nut-price>
</template>
```
...
```html
<template>
  <nut-price :price="15213.1221" :decimal-digits="3" thousands></nut-price>
</template>
```

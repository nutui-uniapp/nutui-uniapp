...
<template>
  <div class="demo h-100vh!">
    ...
    <nut-cell is-link title="基础用法" :show-icon="true" @click="showPreview1 = true" />
    ...
    <nut-cell is-link title="自定义图片" :show-icon="true" @click="showPreview2 = true" />

    <h2 class="title">
      自定义加载动画模式
    </h2>
    <nut-loading-page custom-color="skyblue" loading-color="skyblue" bg-color="#e8e8e8" :loading="showPreview3" @click="showPreview3 = false" />
    <nut-cell is-link title="自定义加载动画模式" :show-icon="true" @click="showPreview3 = true" />
  </div>
</template>
